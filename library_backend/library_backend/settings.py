...
# Security
SECRET_KEY = config('SECRET_KEY', default='django-insecure-change-this-in-production-xkq92nz8')
...
# ─── Fine Configuration ──────────────────────────────────────────────────────
# Fine per day in Rupees for overdue books
FINE_PER_DAY = config('FINE_PER_DAY', default=5, cast=int)
